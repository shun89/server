...
from .serializers import UserSerializer, ResetPasswordSerializer, RetrievePasswordSerializer
from .paginations import Pagination
from .utils import gen_reset_password_email_html, extract_reset_password_user
...
class UserViewSet(viewsets.ModelViewSet):
	...
	def retrieve_password(self, request, pk=None):
		...
		if User.objects.filter(email=email).exists():
			...
			return Response(data={'detail': '该邮箱没有注册!'}, status=status.HTTP_400_BAD_REQUEST)
